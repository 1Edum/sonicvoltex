...
export default function Sidebar() {
  ...
  return (
    <div className='p-1 flex flex-col gap-2 md:h-[90vh]'>
        <h1 className='text-green-400 text-3xl text-center py-6 bg-zinc-100 rounded-md'>
            SonicVoltex
        </h1>
        <div className='md:py-2 bg-zinc-100 flex md:flex-col md:gap-2 px-2 flex-row justify-between'>
            <div className='flex items-center gap-3 group cursor-pointer'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8 group-">
                ...
                <div>
                    ...
                    {mostrarCaixaDeTexto && (
                        <div className="relative z-50 flex items-start justify-end">
                            <div className='absolute md:px-10 lg:left-[50vh] py-3 flex flex-col gap-2 rounded-md bg-zinc-100 border-green-400 border-2'>
