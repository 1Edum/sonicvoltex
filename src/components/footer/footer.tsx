...
function Footer() {
  ...
  return (
    <footer className="flex justify-between items-center w-full h-[10vh] px-4 dark:bg-zinc-700 bg-zinc-100">
      ...
      <div className="flex w-1/3 justify-end items-center">
        ...
        <div className="w-16 h-2 rounded-md relative bg-black">
            <div className="absolute w-3 h-2 rounded-md bg-zinc-400"/>
        </div>
